...
export type Wallpaper = {
  id: string;
  /** Libellé court, affiché en mono majuscule dans la galerie. */
  label: string;
  group: "Bureau" | "Grilles" | "Matières" | "Nuit" | "Perso";
  kind: WallpaperKind;
...
/** Opacité par défaut : le fond doit rester derrière le contenu, jamais devant. */
export const DEFAULT_DIM = 0.14;
...
export const WALLPAPERS: Wallpaper[] = [
  // ── Bureau ────────────────────────────────────────────────────────────────
  {
    ...
    color: CREAM,
    suggestedDim: 1,
    caption: "Le crème d'origine. Rien pour distraire.",
  },
  {
    id: "paper",
    label: "Papier",
    ...
    color: "#f2ecdf",
    tile: "24px 24px",
    pattern: svg(`<rect width='24' height='24' fill='none'/><path d='M0 23.5 H24' stroke='${INK}' stroke-opacity='0.25' stroke-width='1'/>`, 24),
    suggestedDim: 0.5,
  ...
  },
  {
    ...
    color: "#dfd0b4",
    tile: "16px 16px",
    pattern: svg(`<circle cx='4' cy='4' r='1.4' fill='${INK}' fill-opacity='0.18'/><circle cx='12' cy='11' r='1' fill='${INK}' fill-opacity='0.12'/>`, 16),
    suggestedDim: 0.35,
  },
  ...
  // ── Grilles ───────────────────────────────────────────────────────────────
  {
    ...
    color: CREAM,
    tile: "24px 24px",
    pattern: svg(`<path d='M24 0 H0 V24' fill='none' stroke='${INK}' stroke-opacity='0.35' stroke-width='1'/>`, 24),
    suggestedDim: 0.35,
    caption: "La grille système. Sobre, structurante.",
  },
  {
    id: "blueprint",
    label: "Blueprint",
    ...
    color: "#1d2b3a",
    tile: "40px 40px",
    pattern: svg(`<path d='M40 0 H0 V40' fill='none' stroke='#9fc6e8' stroke-opacity='0.55' stroke-width='1'/><path d='M8 0 V40 M16 0 V40 M24 0 V40 M32 0 V40 M0 8 H40 M0 16 H40 M0 24 H40 M0 32 H40' stroke='#9fc6e8' stroke-opacity='0.2' stroke-width='0.5'/>`, 40),
    suggestedDim: 0.5,
    caption: "Plan d'architecte. Ingénierie, physique, systèmes.",
  },
  {
    id: "dots",
    label: "Points",
    ...
    color: "#f0e9db",
    tile: "20px 20px",
    pattern: svg(`<circle cx='2' cy='2' r='1.2' fill='${DEEP_PURPLE}' fill-opacity='0.5'/>`, 20),
    suggestedDim: 0.4,
  },
  ...
  // ── Matières ──────────────────────────────────────────────────────────────
  {
    ...
    color: "#efe7f5",
    tile: "80px 80px",
    pattern: svg(`<g fill='none' stroke='${PURPLE}' stroke-opacity='0.45' stroke-width='1.2'><path d='M10 40 Q30 12 52 30 T78 22'/><path d='M4 66 Q28 54 44 70 T76 62'/></g><g fill='${DEEP_PURPLE}' fill-opacity='0.5'><circle cx='10' cy='40' r='2.4'/><circle cx='52' cy='30' r='2'/><circle cx='44' cy='70' r='2'/><circle cx='78' cy='22' r='1.8'/></g>`, 80),
    suggestedDim: 0.35,
    caption: "Neurosciences, cognition, apprentissage.",
  },
  {
    id: "ledger",
    label: "Registre",
    ...
    color: "#e9ecdf",
    tile: "60px 30px",
    pattern: svg(`<rect width='60' height='30' fill='none'/><path d='M0 29.5 H60' stroke='${INK}' stroke-opacity='0.22' stroke-width='1'/><path d='M40 0 V30' stroke='${OCHRE}' stroke-opacity='0.4' stroke-width='1'/>`, 60),
    suggestedDim: 0.4,
  ...
  },
  {
    ...
    color: "#e6e2f2",
    tile: "100px 100px",
    pattern: svg(`<g fill='none' stroke='${DEEP_PURPLE}' stroke-opacity='0.35' stroke-width='1'><ellipse cx='50' cy='50' rx='44' ry='18'/><ellipse cx='50' cy='50' rx='18' ry='44'/><ellipse cx='50' cy='50' rx='34' ry='34'/></g><circle cx='50' cy='50' r='3' fill='${OCHRE}' fill-opacity='0.7'/>`, 100),
    suggestedDim: 0.3,
  ...
  },
  {
    ...
    color: "#e4e8dd",
    tile: "120px 120px",
    pattern: svg(`<g fill='none' stroke='#3f5c47' stroke-opacity='0.35' stroke-width='1'><path d='M0 90 Q30 60 60 84 T120 70'/><path d='M0 72 Q34 44 62 66 T120 52'/><path d='M0 54 Q36 30 64 48 T120 34'/><path d='M0 36 Q38 16 66 30 T120 16'/></g>`, 120),
    suggestedDim: 0.35,
  ...
  // ── Nuit ──────────────────────────────────────────────────────────────────
  {
    ...
    color: "#16131f",
    suggestedDim: 1,
    caption: "Sessions tardives. Le contenu reste lisible.",
  },
  {
    id: "starfield",
    label: "Ciel",
    ...
    color: "#141225",
    tile: "140px 140px",
    pattern: svg(`<g fill='#ece5d6'><circle cx='18' cy='24' r='1.3' fill-opacity='0.85'/><circle cx='96' cy='12' r='0.9' fill-opacity='0.6'/><circle cx='60' cy='62' r='1.6' fill-opacity='0.9'/><circle cx='124' cy='88' r='1' fill-opacity='0.55'/><circle cx='34' cy='104' r='1.2' fill-opacity='0.7'/><circle cx='108' cy='46' r='0.8' fill-opacity='0.5'/><circle cx='76' cy='126' r='1.1' fill-opacity='0.65'/></g>`, 140),
    suggestedDim: 0.9,
  },
];
